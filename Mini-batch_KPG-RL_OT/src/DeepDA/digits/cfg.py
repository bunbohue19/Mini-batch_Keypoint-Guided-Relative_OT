...
def parse_args():
    ...
    parser.add_argument("--tau_s", type=float, default=0.1, help="softmax temperature for source relation profiles")
    parser.add_argument("--tau_t", type=float, default=0.1, help="softmax temperature for target relation profiles")
